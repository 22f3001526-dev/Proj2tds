...
```bash
git clone https://github.com/22f3001526-dev/Proj2tds.git
...
**Author**: Dushant Sanjay
**Course**: Tools in Data Science (TDS)
**Institution**: IIT Madras

For questions or issues, please open an issue on the [GitHub repository](https://github.com/22f3001526-dev/Proj2tds).